...
// Base card - surface background, border, hover gold glow
...
// Elevated inner card (nested content)
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "font-display text-xl font-semibold leading-tight tracking-wide text-foreground",
      className
    )}
    {...props}
  />
