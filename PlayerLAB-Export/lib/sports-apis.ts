...
class MultiSportsAPI {
  ...
  private async fetchSleeperNFLData(playerId?: string): Promise<any[]> {
    try {
      const response = await fetch(`${FREE_APIS.NFL_STATS}/players/nfl`)
  ...
  private async fetchBallDontLieNBAData(playerId?: string): Promise<any[]> {
    try {
      const response = await fetch(`${FREE_APIS.NBA_STATS}/players?per_page=50`)
      if (!response.ok) throw new Error(`HTTP ${response.status}`)
  ...
  private async fetchMLBStatsData(playerId?: string): Promise<any[]> {
    try {
      const response = await fetch(`${FREE_APIS.MLB_STATS}/sports/1/players`)
      if (!response.ok) throw new Error(`HTTP ${response.status}`)
  ...
  private async fetchNHLStatsData(playerId?: string): Promise<any[]> {
    try {
      const response = await fetch(`${FREE_APIS.NHL_STATS}/skaters`)
      if (!response.ok) throw new Error(`HTTP ${response.status}`)
  ...
  private async fetchESPNNFLData(playerId?: string): Promise<any[]> {
    try {
      const response = await fetch(`${FREE_APIS.ESPN}/football/nfl/athletes`)
      if (!response.ok) throw new Error(`HTTP ${response.status}`)
  ...
  private async fetchESPNNBAData(playerId?: string): Promise<any[]> {
    try {
      const response = await fetch(`${FREE_APIS.ESPN}/basketball/nba/athletes`)
      if (!response.ok) throw new Error(`HTTP ${response.status}`)
  ...
  private async fetchESPNMLBData(playerId?: string): Promise<any[]> {
    try {
      const response = await fetch(`${FREE_APIS.ESPN}/baseball/mlb/athletes`)
      if (!response.ok) throw new Error(`HTTP ${response.status}`)
  ...
  private async fetchESPNNHLData(playerId?: string): Promise<any[]> {
    try {
      const response = await fetch(`${FREE_APIS.ESPN}/hockey/nhl/athletes`)
      if (!response.ok) throw new Error(`HTTP ${response.status}`)
